...
public class Log4jTest {
    ...
    public void testLog4jIndividualMessages() {
        ...
        assertThat(MonitorFactory.getMonitor("com.jamonapi.log4j.JAMonAppender.message.TRACE: trace message ?","log4j").getHits()).isEqualTo(1);
        assertThat(MonitorFactory.getMonitor("com.jamonapi.log4j.JAMonAppender.message.DEBUG: debug message ?","log4j").getHits()).isEqualTo(2);
        assertThat(MonitorFactory.getMonitor("com.jamonapi.log4j.JAMonAppender.message.INFO: info message ?","log4j").getHits()).isEqualTo(3);
        assertThat(MonitorFactory.getMonitor("com.jamonapi.log4j.JAMonAppender.message.WARN: warn message ?","log4j").getHits()).isEqualTo(4);
        assertThat(MonitorFactory.getMonitor("com.jamonapi.log4j.JAMonAppender.message.ERROR: error message ?","log4j").getHits()).isEqualTo(5);
        assertThat(MonitorFactory.getMonitor("com.jamonapi.log4j.JAMonAppender.message.FATAL: fatal message ?","log4j").getHits()).isEqualTo(6);
    }
    ...
    public void testLog4jIndividualMessages_withDefaults() {
        ...
        assertThat(MonitorFactory.getMonitor("com.jamonapi.log4j.JAMonAppender.message.TRACE: trace message ?","log4j").getHits()).isEqualTo(0);
        assertThat(MonitorFactory.getMonitor("com.jamonapi.log4j.JAMonAppender.message.DEBUG: debug message ?","log4j").getHits()).isEqualTo(0);
        assertThat(MonitorFactory.getMonitor("com.jamonapi.log4j.JAMonAppender.message.INFO: info message ?","log4j").getHits()).isEqualTo(0);
        assertThat(MonitorFactory.getMonitor("com.jamonapi.log4j.JAMonAppender.message.WARN: warn message ?","log4j").getHits()).isEqualTo(0);
        assertThat(MonitorFactory.getMonitor("com.jamonapi.log4j.JAMonAppender.message.ERROR: error message ?","log4j").getHits()).isEqualTo(0);
        assertThat(MonitorFactory.getMonitor("com.jamonapi.log4j.JAMonAppender.message.FATAL: fatal message ?","log4j").getHits()).isEqualTo(0);
    }
