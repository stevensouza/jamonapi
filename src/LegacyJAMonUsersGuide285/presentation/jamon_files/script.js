...
var gDocTable = new Array(
   ...
   new hrefList("slide0115.htm", 1, 2),
   new hrefList("slide0120.htm", 1, 3),
   new hrefList("slide0086.htm", 1, 4),
   new hrefList("slide0122.htm", 1, 5),
   new hrefList("slide0114.htm", 1, 6),
   new hrefList("slide0112.htm", 1, 7),
   new hrefList("slide0061.htm", 1, 8),
   new hrefList("slide0063.htm", 1, 9),
   new hrefList("slide0121.htm", 1, 10),
   new hrefList("slide0085.htm", 1, 11)
);
