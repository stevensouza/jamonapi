 ...
 *    <Valve className="com.jamontomcat.JAMonTomcatValve" size="10000" summaryLabels="default"/>
...
public class JAMonTomcatValve extends org.apache.catalina.valves.ValveBase implements HttpMonManage {
    ...
    private static final String DEFAULT_SUMMARY="default, response.getStatus().value.httpStatus, request.contextpath.ms, response.getStatus().summary.httpStatus";
