...
See [minimalApplicationContext.xml](https://github.com/stevensouza/jamonapi/blob/master/jamon-core/src/test/resources/minimalApplicationContext.xml) for a simple example of how to monitor a spring bean using a bean name.

See [applicationContext.xml](https://github.com/stevensouza/jamonapi/blob/master/jamon-core/src/test/resources/applicationContext.xml) for more examples of how to use AOP and Spring together. This file has a number of other ways to define pointcuts that are commented out. By looking at the file you may see some options that might fit your use case.

[JamonAspectTest](https://github.com/stevensouza/jamonapi/blob/master/jamon-core/src/test/java/com/jamonapi/aop/spring/JamonAspectTest.java) test class shows how these files are used in Spring.
...
JAMon 3.0 uses Spring Framework 5.3.x for AOP integration. The `JamonAspect` class and Spring AOP configuration work the same as in previous versions.
